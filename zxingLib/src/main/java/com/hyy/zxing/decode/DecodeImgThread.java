...
import com.hyy.zxing.DecodeFormatManager;
...
public class DecodeImgThread extends Thread {
    ...
    public void run() {
        ...
        try {
            rawResult = multiFormatReader.decodeWithState(new BinaryBitmap(new HybridBinarizer(new com.hyy.zxing.decode.BitmapLuminanceSource(scanBitmap))));
